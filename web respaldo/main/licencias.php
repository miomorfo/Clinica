...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <h4>
        Altas
        <small>ingrese la alta estimada del paciente</small>
      </h4>
        ...
        <div class="formulario form-group">
	      <form action="funciones/agregarLicencias.php" method="post" id="form_home2"  onsubmit="return valida(this)">
      ...
      <div class="row">
      <div class="col-md-2 col-lg-2">
        <label for="alta">fecha inicio licencia</label>
      ...
      <div class="row">
      <div class="col-md-2 col-lg-2">
        <label for="alta">fecha termino licencia</label>
