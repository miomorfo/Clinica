...
if($_SESSION['nivel']==1){
	...
	$usuarios = mysql_query("SELECT * FROM clientes WHERE id_cliente='$id'");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Edición de personal
        <small>modifique los datos del personal</small>
      </h1>
...
<div class="formulario">
	<form action="funciones/crear_usuarios.php" method="post" id="form_home">
        ...
        <input type="submit" value="Modificar" class="b_inicio"/>
...
<div class="formulario form-group">
	<form action="funciones/editar_usuario_funcion.php?id=<?= $id ?>" method="post" id="form_home">
      ...
      <div class="row">
			    <div class="col-md-4 col-lg-4">
        	        <label for="user">Usuario:</label>
        	        <input id="user" name="user" class="form-control" value="<?= $user ?>"/>
				  </div>
			</div>
      ...
      <div class="row">
			    <div class="col-md-4 col-lg-4">
        	        <label for="pass">Contraseña:</label>
        	        <input id="pass" name="pass" class="form-control" value="<?= $pass ?>"/>
				  </div>
			</div>
