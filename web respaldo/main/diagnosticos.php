...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <h4>
        Diagnosticos
        <small>ingrese el diagnostico del paciente</small>
      </h4>
...
<option></option>
        ...
        <!-- datos para rellenar-->
				...
				<form action="funciones/agregarDiagnostico.php?enfermedad=<?= $rut ?>" method="post" id="form_home2" onsubmit="return valida(this)">
