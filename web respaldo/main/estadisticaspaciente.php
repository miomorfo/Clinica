      ...
      <!--------------------------
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
<!-- -->
<form action="estadisticaspaciente.php?variableql=<?= $variableql ?>" method="post" id="form_home">
 
  <div class="form-group">
    <label for="exampleFormControlSelect1">Seleccione una enfermedad</label>
    <select class="form-control" name="enfermedad">
      <option></option>
<!-- -->
<?php
				$enfermedades = mysql_query("SELECT * FROM tipos_enfermedades");

				while ($fila = mysql_fetch_array($enfermedades)){
					$fila['nombre'];
					$resultado = $fila['nombre'];

					?>
								<option value=""> <?php echo $resultado ?></option>
				<?php
				}
?> 
<!-- -->
...
<button type="submit" value="Guardar" class="btn btn-primary">Buscar</button>
</form>
